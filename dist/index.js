...
class RouteManager extends React.Component {
        ...
        this.setState({
            ...
            if (enteringView && viewStack) {
                const enteringEl = enteringView.ionPageElement
                    ...
                    : undefined;
                const leavingEl = leavingView && leavingView.ionPageElement
                    ? leavingView.ionPageElement
                    : undefined;
                if (enteringEl) {
                    // Don't animate from an empty view
                    const navDirection = leavingEl && leavingEl.innerHTML === ''
                        ? undefined
                        : direction === 'none'
                            ? undefined
                            : direction;
                    this.transitionView(enteringEl, leavingEl, viewStack.routerOutlet, navDirection, !!enteringView.prevId);
                }
                else if (leavingEl) {
    ...
    transitionView(enteringEl, leavingEl, ionRouterOutlet, direction, showGoBack) {
        /**
